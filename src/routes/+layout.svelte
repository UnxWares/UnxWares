...
<svelte:head>
	<meta name="description" content="Bienvenue chez UnxWares. Nous sommes une entreprise Normande innovante spécialisée dans le développement web, d'applications et de jeux avec UnxWares Studio, ainsi que dans l'hébergement cloud, l'infogérance et l'infrastructure IT avec UnxWares Cloud. Nous offrons des solutions numériques pour accompagner la transformation digitale des entreprises.">
