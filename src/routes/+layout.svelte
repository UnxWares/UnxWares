...
<svelte:head>
	<meta name="description" content="Bienvenue chez UnxWares. Nous sommes une entreprise Normande innovante spécialisée dans le développement web, d'applications et de jeux avec UnxWares Studio, ainsi que dans l'hébergement cloud, l'infogérance et l'infrastructure IT avec UnxWares Cloud. Nous offrons des solutions numériques performantes et sécurisées pour accompagner la transformation digitale des entreprises.">
	...
	<meta property="og:image" content="/images/unxwares_logotype.png">
	<meta property="og:type" content="website">

	<meta name="twitter:card" content="summary">
	<meta name="twitter:description" content="Bienvenue chez UnxWares. Nous sommes une entreprise Normande innovante spécialisée dans le développement web, d'applications et de jeux avec UnxWares Studio, ainsi que dans l'hébergement cloud, l'infogérance et l'infrastructure IT avec UnxWares Cloud. Nous offrons des solutions numériques performantes et sécurisées pour accompagner la transformation digitale des entreprises.">
	<meta name="twitter:image" content="/images/unxwares_logotype.png">
</svelte:head>
